...
Client::Client() : _fd(-1), _state(RECEIVING_REQUEST), _cgi(NULL), _cgiBytesSent(0),
                   ...
                   _cgiBodyOffset(0), _clientNumber(++g_clientCounter), _cgiFinalized(false), _cgiFinalizeRequested(false), _listenerPort(0) { }
...
Client::Client(int fd, int listenerPort) : _fd(fd), _state(RECEIVING_REQUEST), _cgi(NULL), _cgiBytesSent(0),
                   ...
                   _peerClosed(false), _cgiHeadersSent(false),
                   _sent100Continue(false), _cgiBodyRemaining((size_t)-1),
                   _cgiBodyOffset(0), _clientNumber(++g_clientCounter), _cgiFinalized(false), _cgiFinalizeRequested(false), _listenerPort(listenerPort) { }
